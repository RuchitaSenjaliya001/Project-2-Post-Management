    ...
    <>
      ...
      <div
        className={`flex flex-col ${
          mode === "dark" && "bg-[#0B1120] text-white "
        } dark:shadow-xl h-full sm:max-w-xl rounded-lg overflow-hidden pb-5 ${
        ...
        <div onClick={isLocal && onClick}>
          ...
          <div className="">
            ...
            <p
              className={` ${
                mode === "dark" ? "text-[#ABB1BC]" : "text-gray-800"
              } text-lg px-5 pb-5 text-justify text-ellipsis`}>
              {body}
            </p>
          </div>
        </div>
        <div className="flex flex-col justify-end h-full px-5">
          {isAdmin && (
            <div className="flex justify-end space-x-4">
              <Button
                title="Delete"
                className="bg-[#ef4444] hover:bg-[#dc2626] rounded-md"
