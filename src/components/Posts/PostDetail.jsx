...
export default function PostDetail() {
    ...
    return (
        <>
            ...
            <div className={`${ctx.mode === 'dark' && ' bg-gradient-to-b from-[#1a2338] via-[#1b3576] to-[#1a2338]'} pt-10 w-full min-h-screen`}>
                <div className={`${ctx.mode === 'dark' ? 'bg-[#0B1120] text-white' : 'border-2'} max-w-7xl m-auto flex gap-8  justify-between shadow-xl rounded-lg p-5`}>
                    <div className="w-1/2">
                        <img
                    ...
                    <div className="w-1/2 flex flex-col justify-between">
                        ...
                        {user.role === 'admin' && <div className="flex justify-end space-x-5 my-4">
                            ...
                            <Button
                                title="Edit"
                                className={`${ctx.mode === 'dark' ? 'bg-[#6366F1] hover:bg-[#454bf7]' : 'bg-[#201D75] hover:bg-[#121056]'}`}
